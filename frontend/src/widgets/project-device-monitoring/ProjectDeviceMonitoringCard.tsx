...
export function ActuatorRow({
  ...
  return <TableRow>
    ...
    <TableCell className="whitespace-nowrap text-sm text-muted-foreground" title={actuator.last_db_updated_at ? formatDateTime(actuator.last_db_updated_at) : undefined}>{formatVietnamTime(actuator.last_db_updated_at)}</TableCell>
