...
import { getScadaRuntime, listAlerts, queryKeys } from "@/api/resources"
...
export function OwnerOverviewPage() {
  ...
  if (alerts.isLoading || scada.isLoading) return <OwnerOverviewSkeleton />
  ...
  return <OwnerOverviewBoard systemId={systemId} model={createOwnerOverviewModel(system, alerts.data ?? [])} scadaRuntime={scada.data} />
}
